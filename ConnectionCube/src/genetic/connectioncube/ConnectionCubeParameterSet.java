...
import genetic.conncube.algo.ConnectionCubeCollissionDetection;
import genetic.conncube.algo.ConnectionCubeSelectionAlgorithm;
import genetic.conncube.algo.ConnectionCubeXOverWithMutation;
 ...
 *
 */
public class ConnectionCubeParameterSet implements GAParameterSet{
	...
	public void setDefaultvalues() {
		...
		IndividualsFactory indFac = new ConnectionCubeIndividualsFactory();
		...
		ReproductionAlgorithm reprAlg = new ConnectionCubeXOverWithMutation();
		params.put("reproductionAlgorithm", reprAlg);

		SelectionAlgorithm selAlg = new ConnectionCubeSelectionAlgorithm();
		params.put("selectionAlgorithm", selAlg);

		FitnessEvaluationAlgorithm fitAlg = (FitnessEvaluationAlgorithm) new ConnectionCubeCollissionDetection();
